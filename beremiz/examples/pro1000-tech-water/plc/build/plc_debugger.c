 ...
 * Declare programs 
 **/
extern MAIN RESOURCE1__INSTANCE0;

/***
 * Declare global variables from resources and conf 
 **/
extern __IEC_BOOL_p CONFIG__LT_LOW;
extern __IEC_BOOL_p CONFIG__LT_MIDDLE;
extern __IEC_BOOL_p CONFIG__LT_HIGHT;
extern __IEC_BOOL_p CONFIG__HS_AUTO;
extern __IEC_BOOL_p CONFIG__P_SPEED_50;
extern __IEC_BOOL_p CONFIG__P_SPEED_100;
extern __IEC_BOOL_p CONFIG__P_START;
extern __IEC_BOOL_p CONFIG__LT_ERROR;
extern __IEC_BOOL_p CONFIG__LT_SET;
extern __IEC_WORD_p CONFIG__PLC_STATE;
extern       MAIN   RESOURCE1__INSTANCE0;
...
{&(CONFIG__LT_LOW), BOOL_P_ENUM},
{&(CONFIG__LT_MIDDLE), BOOL_P_ENUM},
{&(CONFIG__LT_HIGHT), BOOL_P_ENUM},
{&(CONFIG__HS_AUTO), BOOL_P_ENUM},
{&(CONFIG__P_SPEED_50), BOOL_O_ENUM},
{&(CONFIG__P_SPEED_100), BOOL_O_ENUM},
{&(CONFIG__P_START), BOOL_O_ENUM},
{&(CONFIG__LT_ERROR), BOOL_O_ENUM},
{&(CONFIG__LT_SET), BOOL_O_ENUM},
{&(CONFIG__PLC_STATE), WORD_O_ENUM},
{&(RESOURCE1__INSTANCE0.LT_LOW), BOOL_P_ENUM},
{&(RESOURCE1__INSTANCE0.LT_LOW_F), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.LT_MIDDLE), BOOL_P_ENUM},
{&(RESOURCE1__INSTANCE0.LT_MIDDLE_F), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.LT_HIGHT), BOOL_P_ENUM},
{&(RESOURCE1__INSTANCE0.LT_HIGHT_F), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.HS_AUTO), BOOL_P_ENUM},
{&(RESOURCE1__INSTANCE0.HS_AUTO_F), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.P_SPEED_50), BOOL_P_ENUM},
{&(RESOURCE1__INSTANCE0.P_SPEED_50L), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.P_SPEED_100), BOOL_P_ENUM},
{&(RESOURCE1__INSTANCE0.P_SPEED_100L), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.P_START), BOOL_P_ENUM},
{&(RESOURCE1__INSTANCE0.P_STARTL), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.LT_ERROR), BOOL_P_ENUM},
{&(RESOURCE1__INSTANCE0.LT_ERRORL), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.LT_SET), BOOL_P_ENUM},
{&(RESOURCE1__INSTANCE0.PLC_STATE), WORD_P_ENUM},
...
{&(RESOURCE1__INSTANCE0.TM_5S), TIME_ENUM},
...
{&(RESOURCE1__INSTANCE0.TON3.EN), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.TON3.ENO), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.TON3.IN), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.TON3.PT), TIME_ENUM},
{&(RESOURCE1__INSTANCE0.TON3.Q), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.TON3.ET), TIME_ENUM},
{&(RESOURCE1__INSTANCE0.TON3.STATE), SINT_ENUM},
{&(RESOURCE1__INSTANCE0.TON3.PREV_IN), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.TON3.CURRENT_TIME), TIME_ENUM},
{&(RESOURCE1__INSTANCE0.TON3.START_TIME), TIME_ENUM},
{&(RESOURCE1__INSTANCE0.NOT95_OUT), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.OR68_OUT), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.OR58_OUT), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.OR80_OUT), BOOL_ENUM},
{&(RESOURCE1__INSTANCE0.WORD_TO_INT93_OUT), INT_ENUM},
{&(RESOURCE1__INSTANCE0.INC91_OUT), INT_ENUM},
{&(RESOURCE1__INSTANCE0.INT_TO_WORD94_OUT), WORD_ENUM}
};
