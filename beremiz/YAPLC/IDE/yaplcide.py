...
class YAPLCIdeLauncher(BeremizIDELauncher):
    ...
    def __init__(self):
	    ...
	    ('PLC107_MAIN', 'PLC107_MAIN.PLC107_MAIN'),
            ('PLC107_SYS', 'PLC107_SYS.PLC107_SYS'),
	    ('PLC107_DI', 'PLC107_DI.PLC107_DI'),
            ('PLC107_DO', 'PLC107_DO.PLC107_DO'),
            ('PLC107_AI', 'PLC107_AI.PLC107_AI'),
            ('PLC107_AO', 'PLC107_AO.PLC107_AO')]
