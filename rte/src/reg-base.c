 ...
 */
inline REG_t *REG_GetByIDx(const uint16_t IDxIn)
{
...
REG_t *REG_GetByMbAddr(const uint8_t MbTableIn, const uint16_t MbAddrIn)
{
    ...
    switch(MbTableIn)
    {
        case MBRTU_COIL_TABLE_ID:
            ...
            else if(VAL_IN_LIMITS(REG_DO_SAFE_ALLOW__MBPOS, MbAddrIn, REG_DO_SAFE_ALLOW__MBPOS_END))
            {
                iGroup = REG_CALC_POS_BY_MBADDR(MbAddrIn, REG_DO_SAFE_ALLOW__MBPOS, REG_DO_SAFE_ALLOW__TYPE_WSZ);
                Pos    = REG_DO_SAFE_ALLOW__POS;
            }
            else if(VAL_IN_LIMITS(REG_DO_SAFE_VAL__MBPOS, MbAddrIn, REG_DO_SAFE_VAL__MBPOS_END))
            {
                iGroup = REG_CALC_POS_BY_MBADDR(MbAddrIn, REG_DO_SAFE_VAL__MBPOS, REG_DO_SAFE_VAL__TYPE_WSZ);
                Pos    = REG_DO_SAFE_VAL__POS;
            }
        ...
        case MBRTU_DISC_TABLE_ID:
            ...
            else if(VAL_IN_LIMITS(REG_DI_TACH_SETPOINT_RES__MBPOS, MbAddrIn, REG_DI_TACH_SETPOINT_RES__MBPOS_END))
            {
                iGroup = REG_CALC_POS_BY_MBADDR(MbAddrIn, REG_DI_TACH_SETPOINT_RES__MBPOS, REG_DI_TACH_SETPOINT_RES__TYPE_WSZ);
                Pos    = REG_DI_TACH_SETPOINT_RES__POS;
            }
            else if(VAL_IN_LIMITS(REG_DI_CNTR_SETPOINT_RES__MBPOS, MbAddrIn, REG_DI_CNTR_SETPOINT_RES__MBPOS_END))
            {
                iGroup = REG_CALC_POS_BY_MBADDR(MbAddrIn, REG_DI_CNTR_SETPOINT_RES__MBPOS, REG_DI_CNTR_SETPOINT_RES__TYPE_WSZ);
                Pos    = REG_DI_CNTR_SETPOINT_RES__POS;
            }
            else
            {
                return (0);
 ...
 *  @arg      = 1 - OK
 */
inline uint8_t REG_MonitorSendToQueueData(REG_t *RegIn)
{
    return (REG_MonitorSendToQueue(RegIn, RTOS_Q_DataRegMonitor));
}
 ...
 *  @arg      = 1 - changed
 */
inline uint8_t REG_Monitor(REG_t *RegIn, QueueHandle_t QueueIn, const uint16_t ValIn, const uint16_t ValPrevIn)
{
...
{
    if(IDxIn < REG_SZ) return (REG_Monitor(&REGS[IDxIn], QueueIn, ValIn, ValPrevIn));
    return (BIT_FALSE);
}
 ...
 *  @arg      = 1 - changed
 */
inline uint8_t REG_MonitorForQueueData(REG_t *RegIn, const uint16_t ValIn, const uint16_t ValPrevIn)
{
    return (REG_Monitor(RegIn, RTOS_Q_DataRegMonitor, ValIn, ValPrevIn));
}
 ...
 *  @arg      = 1 - changed
 */
inline uint8_t REG_MonitorForQueueDataByMbAddr(const uint8_t MbTableIn, const uint16_t MbAddrIn, const uint16_t ValIn, const uint16_t ValPrevIn, uint16_t *IDxIn)
{
    return (REG_MonitorByMbAddr(MbTableIn, MbAddrIn, RTOS_Q_DataRegMonitor, ValIn, ValPrevIn, IDxIn));
}
...
static uint8_t REG_CopyRegByte(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    uint8_t Var;
...
static uint8_t REG_CopyRegWord(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    uint16_t Var;
...
static uint8_t REG_CopyRegDWord(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    uint32_t Var;
...
static uint8_t REG_CopyRegLWord(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    uint64_t Var;
...
static uint8_t REG_CopyRegSInt(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    int8_t Var;
...
static uint8_t REG_CopyRegInt(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    int16_t Var;
...
static uint8_t REG_CopyRegDInt(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    int32_t Var;
...
static uint8_t REG_CopyRegLInt(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    int64_t Var;
...
static uint8_t REG_CopyRegFloat(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    float Var;
...
static uint8_t REG_CopyRegDouble(REG_t *RegIn, const uint8_t DstIn, const void *VarIn, const uint8_t VarTypeIn)
{
    double Var;
 ...
 *   Type of Reg must be eq. type of Var!
 */
inline uint8_t REG_CopyRegByPos(const uint16_t RegPosIn, const uint8_t DstIn, void *VarIn)
{
    return ((RegPosIn < REG_SZ) ? REG_CopyReg(&REGS[RegPosIn], DstIn, VarIn) : (uint16_t)0);
}
...
uint16_t REG_CopyRegs(const uint16_t PosIn, const uint16_t SzIn, const uint8_t DstIn, void *VarIn)
{
    ...
    if(PosIn < REG_SZ && SzIn > 0 && PosEnd < REG_SZ)
    {
        ...
        {
            Res+= REG_CopyReg((Reg+i), DstIn, VarIn);
        }
    }
    return (Res);
}
    ...
    if(PosIn < REG_SZ && SzIn > 0 && PosEnd < REG_SZ && SaddrIn < REG_ADDR_MAX && AddrEnd < REG_ADDR_MAX && WSz > 0)
    {
        ...
        for(i=PosIn; i<=PosEnd; i++, Addr++, Res++)
        {
...
#ifdef RTE_MOD_EEPROM
            (Reg+i)->EeAreaID  = EeAreaIn;
            (Reg+i)->EeAddr    = ((EePosIn > PLC_EEPROM_ADDR_NONE) ? REG_CALC_MBADDR(Addr, Sz, EePosIn) : PLC_EEPROM_ADDR_NONE);
#endif // RTE_MOD_EEPROM
            ...
            if(i == PosIn || i == PosEnd)
            {
                ...
                if((Reg+i)->EeAddr > PLC_EEPROM_ADDR_NONE)
                {
                    DebugLog(" EeArea=%c EeAddr=%d", EeArea[EeAreaIn], (Reg+i)->EeAddr);
                }
#endif // RTE_MOD_EEPROM
