 ...
 *  @note
 *       Bitfield:
 *       uint16_t Major:4 (0...3  bits)
 *       uint16_t Minor:4 (4...7  bits)
 *       uint16_t Patch:4 (8...11 bits)
 */
#define PLC_RTE_VERSION                (uint16_t)17     //1.1.0

/** @def RTE year
 */
#define PLC_RTE_YYYY                   (uint16_t)2022

/** @def RTE day.month
 *  @note
 *       Bitfield:
 *       uint16_t DD:5 (0...4 bits)
 *       uint16_t MM:5 (5...9 bits)
 */
#define PLC_RTE_DDMM                   (uint16_t)217     //25.06
...
/** @def NVIC priorities
 */
#define PLC_NVIC_PRIO_GROUP            NVIC_PriorityGroup_2
//USART (MBRTU)
#define PLC_NVIC_PPRIO_USART_MBRTU     (uint8_t)0
#define PLC_NVIC_SPRIO_USART_MBRTU     (uint8_t)0
//USART (DBG)
#define PLC_NVIC_PPRIO_USART_DBG       (uint8_t)0
#define PLC_NVIC_SPRIO_USART_DBG       (uint8_t)1
//DI.0,1,2
#define PLC_NVIC_PPRIO_DI012           (uint8_t)1
#define PLC_NVIC_SPRIO_DI012           (uint8_t)0
//DI.3
#define PLC_NVIC_PPRIO_DI3             (uint8_t)1
#define PLC_NVIC_SPRIO_DI3             (uint8_t)1
//TIM3 (APP)
#define PLC_NVIC_PPRIO_TIM3            (uint8_t)3
#define PLC_NVIC_SPRIO_TIM3            (uint8_t)1
//TIM2 (DO)
#define PLC_NVIC_PPRIO_TIM2            (uint8_t)3
#define PLC_NVIC_SPRIO_TIM2            (uint8_t)0
